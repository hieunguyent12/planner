    ...
    <BaseDialog.Root open={isOpen} onOpenChange={toggle}>
      <BaseDialog.Portal>
        ...
        <BaseDialog.Popup
          ...
          className={cn(
            "fixed top-1/2 left-1/2 -mt-8 max-w-[42rem] -translate-x-1/2 rounded-md bg-primary text-primary-foreground outline-1 outline-primary-border transition-all duration-150 data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[starting-style]:scale-90 data-[starting-style]:opacity-0",
            className
          )}
        >
          {children}
